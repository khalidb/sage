...
Select id from (
Select * 
From customer_rp, n_orders, v_lineitem, nation
Where (c_custkey = o_custkey) and (o_orderkey = l_orderkey) and (c_nationkey = n_nationkey) and ((o_orderdate || '') like '1996%')
);
...
Select id from (
Select * 
From customer, orders_rp, v_lineitem, nation
Where (c_custkey = o_custkey) and (o_orderkey = l_orderkey) and (c_nationkey = n_nationkey) and ((o_orderdate || '') like '1996%')
);
...
Select id from (
Select * 
From customer, n_orders, lineitem_rp, nation
Where (c_custkey = o_custkey) and (o_orderkey = l_orderkey) and (c_nationkey = n_nationkey) and ((o_orderdate || '') like '1996%')
);
...
Select id from (
Select * 
From customer, n_orders, v_lineitem, nation_rp
Where (c_custkey = o_custkey) and (o_orderkey = l_orderkey) and (c_nationkey = n_nationkey) and ((o_orderdate || '') like '1996%')
);
